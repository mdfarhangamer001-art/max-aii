    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-[#030308] relative overflow-hidden">
      ...
      >
        ...
        <div className="flex flex-col gap-4 mt-auto">
          <div className="bg-slate-950/40 border border-white/5 rounded-xl p-3.5 flex flex-col gap-2.5">
            <button
              id="google-signin-btn"
              onClick={handleGoogleSignIn}
              disabled={loading}
              className="w-full py-3 px-5 rounded-lg bg-white hover:bg-slate-100 text-slate-950 font-sans text-xs font-semibold flex items-center justify-center gap-2.5 transition-all duration-300 hover:shadow-[0_0_20px_rgba(255,255,255,0.15)] cursor-pointer disabled:opacity-50 select-none uppercase tracking-wider text-[11px]"
            >
              {loading ? (
            ...
            <div className="flex flex-col gap-0.5">
              ...
              <span className="text-[9px] font-mono text-slate-500 leading-normal">
                Back up your chat histories, preferences, and long-term companion memories to a secure private Firestore database. Access them seamlessly across all devices.
              </span>
            </div>
          </div>
          ...
          <div className="bg-slate-950/40 border border-white/5 rounded-xl p-3.5 flex flex-col gap-2.5">
            <button
              ...
              disabled={loading}
              className="w-full py-3 px-5 rounded-lg bg-slate-900 hover:bg-slate-800 text-slate-200 border border-white/10 font-sans text-xs font-semibold flex items-center justify-center gap-2 transition-all duration-300 cursor-pointer disabled:opacity-50 select-none uppercase tracking-wider text-[11px]"
            >
              <WifiOff size={14} className="text-cyan-400" />
              <span>Continue offline / Use Locally</span>
            </button>
            <div className="flex flex-col gap-0.5">
              <span className="text-[10px] font-bold text-cyan-400 uppercase tracking-wider">Offline-First Private Mode</span>
              <span className="text-[9px] font-mono text-slate-500 leading-normal">
                100% private. All companion memory and chat history remain stored locally on this computer (<span className="text-cyan-500">memories.json</span>). No personal data is sent to the cloud.
              </span>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center gap-1.5 mt-2">
            ...
            <p className="text-[9px] font-mono text-cyan-400 uppercase tracking-widest text-center">
              Awaiting user console selection
            </p>
          </div>
        </div>
